import {
  ...
  import RecipeCardBigTest from "./RecipeCardBigTest";
  ...
  export default function RecipeCardSmallTest(props) {
    ...
    return (
      <Card velevation={3}>
        ...
        >
          <RecipeCardBigTest recipe={props.recipe}></RecipeCardBigTest>
        </Popup>
